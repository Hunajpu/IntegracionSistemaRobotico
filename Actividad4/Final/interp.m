...
if (inter==1)
    ...
    for i=1:1:n
        t=q_0_6(i+1,4);
        q(T+1:T+(t*10),:)=[pol_3(q_0_6(i,1),q_0_6(i+1,1),t) pol_3_rpp(q_0_6(i,2),q_0_6(i+1,2),t)  pol_3_rpp(q_0_6(i,3),q_0_6(i+1,3),t)];
...
elseif(inter==3)
    ...
    for i=1:1:n
        ...
        q(T+1:T+(t*10),:)=[LSPB(q_0_3(i,1),q_0_3(i+1,1),t) LSPB_rpp(q_0_3(i,2),q_0_3(i+1,2),t)  LSPB_rpp(q_0_3(i,3),q_0_3(i+1,3),t)];
